...
int main(int argc, const char * argv[]) {
    ...
    printf("signed long min  = %ld\t", LONG_MIN); printf("32位\n");
    printf("signed long max  = %ld\t", LONG_MAX); printf("32位\n");
    printf("无符号类型\n");
    ...
    printf("unsigned long max  = %lu\t", ULONG_MAX); printf("32位\n\n");
    ...
    printf("signed long min  = %ld\t", -(long)((unsigned long) ~0 >> 1)); printf("32位\n");
    printf("signed long max  = %ld\t", (long)((unsigned long) ~0 >> 1)); printf("32位\n");
    printf("无符号类型\n");
    ...
    printf("unsigned long max  = %lu\t", (unsigned long) ~0 ); printf("32位\n");
